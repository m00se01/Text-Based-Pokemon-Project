...
void init_pc()
{
  ...
  world.pc.items[item_potion] = 5;
  
  //Pokeballs
  world.pc.items[item_pokeball] = 10;
...
// void pc_starter(pc *p){
//   //Random Number from 1 to end of pokemon list
//     int index = rand() %  1092 + 1 ;

//     int i;
//     for(i = 0; i< 6; i++){
//       if(p->pokemon_party[i] == NULL ){
//          //choose io;
//       }
//     }
// }
